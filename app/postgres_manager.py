# taken from: https://gist.github.com/valferon/4d6ebfa8a7f3d4e84085183609d10f14?permalink_comment_id=3172364
...
if __name__ == "__main__":
    ...
    # new filename should be todays date
    filename_compressed = "{}.gz".format(datetime.datetime.now().strftime("%Y%m%d"))
    upload_to_s3(comp_file, filename_compressed)
